                    ...
                    <div class="container">
                        <div class="nav-wrapper"><a href="" class="brand-logo"><img src="img/logo.jpeg" width="50px"
                            ...
                            <ul class="right hide-on-med-and-down" id="mobile-demo">
                                <li class="{{ Route::currentRouteNamed('index') ? 'active' : '' }}"><a
                                        href="/index">Beranda</a></li>
                                <li class="{{ Route::currentRouteNamed('about') ? 'active' : '' }}"><a
                                        class="dropdown-trigger" href="#!" data-target="dropdown1">Tentang Kami<i
            ...
            < !--side nav-->
                <ul class="sidenav" id="mobile-nav">
                    ...
                    <li class="{{ Route::currentRouteNamed('about') ? 'active' : '' }}"><a class="dropdown-trigger"
                            href="#!" data-target="dropdown2">Tentang Kami<i
                                class="material-icons right">arrow_drop_down</i></a></li>
